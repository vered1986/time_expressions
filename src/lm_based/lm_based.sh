...
python -m src.lm_based.extract_distribution_from_lm --device ${device} --include_time_regex;
...
do
  ...
  python -m src.compute_start_end_for_24h_clock --lang ${lang} --out_dir output/lm_based/regex;
done
